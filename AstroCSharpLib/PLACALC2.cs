...
namespace AstroCSharpLib
{
    public partial class CALC
    {
        ...
        bool FPlacalcPlanet(int ind, double jd, bool helio, ref double obj, ref double objalt, ref double dir, ref double space)
        {
            int iobj, flag;
            ...
            jd_ad += deltat(jd_ad);
            if (calc(iobj, jd_ad, flag, ref rlng, ref rrad, ref rlat, ref rspeed) == 0)
            {
                obj = rlng;
                objalt = rlat;
                dir = rspeed;

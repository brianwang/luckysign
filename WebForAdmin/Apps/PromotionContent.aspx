<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeBehind="PromotionContent.aspx.cs" Inherits="WebForAdmin.Apps.PromotionContent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset class="column-right">
        <p>
            <label>
                选择所属主题</label><asp:DropDownList ID="drpTopic" runat="server" CssClass="medium-input">
                </asp:DropDownList>

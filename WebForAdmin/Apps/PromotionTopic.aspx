<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true" CodeBehind="PromotionTopic.aspx.cs" Inherits="WebForAdmin.Apps.PromotionTopic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset id="fieldset1" runat="server" class="column-left">
        <p>
            <label>
                主题</label><asp:TextBox ID="txtName" CssClass="text-input medium-input" runat="server"></asp:TextBox>
        ...
        <p>
            <label>
                分类</label><asp:DropDownList ID="drpGroup" runat="server" CssClass="small-input">
    ...
    <fieldset id="fieldset2" runat="server" class="column-right">
        <p>
            ...
            <asp:DropDownList ID="drpStatus" runat="server" CssClass="small-input">
                ...
                <asp:ListItem Text="已作废" Value="1"></asp:ListItem>
            </asp:DropDownList>
        </p>
                        ...
                        <asp:Repeater ID="rptFamous" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="Category.aspx?type=edit&id=<%# Eval("SysNo")%>"><%# Eval("Title")%></a>
                                    </td>
                                     <td>
                                        <%# AppCmn.AppEnum.GetAdvTopicType(Eval("Group"))%>
                                    </td>
                                    <td>

<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true"
    CodeBehind="District.aspx.cs" Inherits="WebForAdmin.Celebrity.District" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>
        地区信息管理</h2>
    <p id="page-intro">
        <a href="District.aspx?type=top">返回一级地区列表</a></p>
    ...
    <fieldset id="fieldset2" runat="server" class="column-right">
        <p>
            ...
            <asp:DropDownList ID="drpStatus" runat="server" CssClass="small-input">
                ...
                <p>
            <label>
                英文名</label><asp:TextBox ID="txtEnglishName" CssClass="text-input medium-input" runat="server"></asp:TextBox>
            <%--<span class="input-notification success png_bg" style="display:none;">Successful message</span>--%>
            <!-- Classes for input-notification: success, error, information, attention -->
            <br />
            <small></small>
                    ...
                    <tbody>
                        <asp:Repeater ID="rptFamous" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <a href="District.aspx?type=edit&id=<%# Eval("SysNo")%>"><%# Eval("SysNo")%></a>
                                    </td>
                                    <td>
                                        <a href="District.aspx?type=edit&id=<%# Eval("SysNo")%>"><%# Eval("Name")%></a>
                                    </td>
                                    <td>

<%@ Page Title="" Language="C#" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="true"
    CodeBehind="SetMaster.aspx.cs" Inherits="WebForAdmin.Customer.SetMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset>
        <p>
            <label>
                选择问答版块</label><asp:DropDownList ID="drpQACate" runat="server" CssClass="small-input">
            </asp:DropDownList>
        ...
        <p>
            <asp:Button ID="Button1" CssClass="button" runat="server" Text="设置" OnClick="Unnamed1_Click" />
        </p>
    </fieldset>

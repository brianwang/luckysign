...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline" UpdateMode="Conditional"
    ...
    <ContentTemplate>
        ...
        <div id="pnlpan1" class="block show pp" style="border-bottom: none;">
            <div id="chartdiv" class="res" style="font-family: 宋体; color: #3f3d3e; border-bottom: 1px; border-left: 1px; padding-bottom: 2px; line-height: 13px; padding-left: 2px; padding-right: 2px; font-size: 9pt; border-top: 1px; border-right: 1px; padding-top: 2px; height: auto">
        ...
        <div class="block pp" id="pnlpan2" style="border-bottom: none;">
            <div id="Div1" class="res" style="font-family: 宋体; color: #3f3d3e; border-bottom: 1px; border-left: 1px; padding-bottom: 2px; line-height: 13px; padding-left: 2px; padding-right: 2px; font-size: 9pt; border-top: 1px; border-right: 1px; padding-top: 2px;">
            ...
            <div class="block show pp">
                <div class="box_1">
                    <div class="box_c">
                        ...
                        <asp:Button ID="Button7" runat="server" CssClass="btn_01" Text="上一限" OnClick="Button21_Click" />
                        <asp:Button ID="Button8" runat="server" CssClass="btn_01" Text="下一限" OnClick="Button22_Click" />
                        <asp:Button ID="Button9" runat="server" CssClass="btn_01" Text="上一年" OnClick="Button23_Click" />
                        <asp:Button ID="Button10" runat="server" CssClass="btn_01" Text="下一年" OnClick="Button24_Click" />
            ...
            <div class="block pp">
                <div class="box_1">
                    <div class="box_c">
                        ...
                        <asp:Button ID="Button11" runat="server" CssClass="btn_01" Text="往前一时辰" OnClick="Button25_Click" />
                        <asp:Button ID="Button12" runat="server" CssClass="btn_01" Text="往后一时辰" OnClick="Button26_Click" />

    ...
    <div class="main">
        <div class="index_left">
            ...
            <div class="index_left_box">
                ...
                <div class="paipan_box">
                    <div class="paipan_box_l">
                        第1宫   在<img src="../WebResources/img/paipan/<%=m_astro.Stars[20].Constellation %>.jpg" />
                        <%=PPLive.PublicValue.GetConstellation(m_astro.Stars[20].Constellation) %> <%=m_astro.Stars[20].Degree %>度<%=m_astro.Stars[20].Cent.ToString("00") %>分<a target="_blank" href="http://www.ssqian.com/Article/Index.aspx?key=<%=PPLive.PublicValue.GetAstroStar(m_astro.Stars[20].StarName) %> <%=PPLive.PublicValue.GetConstellation(m_astro.Stars[20].Constellation) %>">查看</a><br />
                        第2宫   在<img src="../WebResources/img/paipan/<%=m_astro.Stars[21].Constellation %>.jpg" />
                        ...
                        第3宫   在<img src="../WebResources/img/paipan/<%=m_astro.Stars[22].Constellation %>.jpg" />
                        ...
                        第4宫   在<img src="../WebResources/img/paipan/<%=m_astro.Stars[23].Constellation %>.jpg" />
                        ...
                        第5宫   在<img src="../WebResources/img/paipan/<%=m_astro.Stars[24].Constellation %>.jpg" />
                        ...
                        第6宫   在<img src="../WebResources/img/paipan/<%=m_astro.Stars[25].Constellation %>.jpg" />
                    ...
                    <div class="paipan_box_l">
                        第7宫   在<img src="../WebResources/img/paipan/<%=m_astro.Stars[26].Constellation %>.jpg" />
                        ...
                        第8宫   在<img src="../WebResources/img/paipan/<%=m_astro.Stars[27].Constellation %>.jpg" />
                        ...
                        第9宫   在<img src="../WebResources/img/paipan/<%=m_astro.Stars[28].Constellation %>.jpg" />
                        ...
                        第10宫   在<img src="../WebResources/img/paipan/<%=m_astro.Stars[29].Constellation %>.jpg" />
                        <%=PPLive.PublicValue.GetConstellation(m_astro.Stars[29].Constellation) %> <%=m_astro.Stars[29].Degree %>度<%=m_astro.Stars[29].Cent.ToString("00") %>分<a target="_blank" href="http://www.ssqian.com/Article/Index.aspx?key=<%=PPLive.PublicValue.GetAstroStar(m_astro.Stars[29].StarName) %> <%=PPLive.PublicValue.GetConstellation(m_astro.Stars[29].Constellation) %>">查看</a><br />
                        第11宫   在<img src="../WebResources/img/paipan/<%=m_astro.Stars[30].Constellation %>.jpg" />
                        ...
                        第12宫   在<img src="../WebResources/img/paipan/<%=m_astro.Stars[31].Constellation %>.jpg" />
                ...
                <div class="paipan_box">
                    <div class="paipan_box_l" style="width: 200px">
                        ...
                        <img src="../WebResources/img/paipan/taiyang.jpg" />太阳拱木星<img src="../WebResources/img/paipan/muxing.jpg" /><a href="#">查看</a><br />
                        <img src="../WebResources/img/paipan/taiyang.jpg" />太阳拱土星<img src="../WebResources/img/paipan/tuxing.jpg" /><a href="#">查看</a><br />
                        <img src="../WebResources/img/paipan/taiyang.jpg" />太阳六合中天<img src="../WebResources/img/paipan/tuxing.jpg" /><a href="#">查看</a><br />
                        <img src="../WebResources/img/paipan/yueliang.jpg" />月亮六合水星<img src="../WebResources/img/paipan/shuixing.jpg" /><a href="#">查看</a><br />
                        <img src="../WebResources/img/paipan/yueliang.jpg" />月亮六合火星<img src="../WebResources/img/paipan/huoxing.jpg" /><a href="#">查看</a><br />
                        <img src="../WebResources/img/paipan/yueliang.jpg" />月亮合海王星<img src="../WebResources/img/paipan/haiwangxing.jpg" /><a href="#">查看</a><br />
                    </div>

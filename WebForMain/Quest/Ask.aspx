<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Main.Master" AutoEventWireup="True"
    CodeBehind="Ask.aspx.cs" Inherits="WebForMain.Quest.Ask" ValidateRequest="false" %>
            ...
            <div class="block show pp">
                <div class="box_1">
                    <div class="box_c" style="padding-top:15px">
                        <span class="fred">*</span><strong>分 类：</strong><asp:DropDownList ID="drpCate" runat="server" onchange="javascript:qaCateChanged(this);">
                        </asp:DropDownList>
                        <div style="display:inline-block"><span id="CateTip" runat="server">为您的问题选择一个合适的分类</span></div>
                        <div class="clear"></div>
                        ...
                        <div style="display:inline-block"><span id="TypeTip" runat="server">请根据您的问题需要仔细选择该类型</span></div>
                        <div class="clear"></div>
                        <span class="fred">*</span><strong>悬赏积分：</strong><asp:TextBox ID="txtPoint" runat="server" CssClass="ipt_3"
                            Text="0"></asp:TextBox>
                        (您目前拥有 <strong class="fred">
                            <asp:Literal ID="ltrPoint" runat="server"></asp:Literal></strong> 积分) <span id="PointTip"
                                runat="server">悬赏额度越高，咨询师的积极性也会越高</span>
                                <div class="clear"></div>
                    </div>
                </div>
                <div id="info1" class="box_1">
                    <div class="box_t">
                        第一当事人信息</div>
                    <div class="box_c">
                        ...
                        <asp:UpdatePanel ID="UpdatePanelb" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                            <ContentTemplate>
                                ...
                                <div style="display:block;width:496px;float:right;text-align:left">
                ...
                <div class="box_1">
                    ...
                    <div class="box_c" style="padding-top:10px">
                        ...
                        <strong style="vertical-align: top"><span class="fred">*</span>问题详情：</strong>
                        <FTB:FreeTextBox id="txtContext" runat="Server" EnableHtmlMode="false" EnableToolbars="false" DesignModeCss="tarea" Width="560px" Height="200px" />
                        <%--<asp:TextBox

<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Main.Master" AutoEventWireup="True"
    CodeBehind="Question.aspx.cs" Inherits="WebForMain.Quest.Question" %>
                                ...
                                <ul>
                                    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" OnItemDataBound="Repeater1_ItemDataBound">
                                        <ItemTemplate>
                                            ...
                                            <li>
                                                <div class="index_new_ask_l">
                                                    <a target="_blank" href="../Qin/View.aspx?id=<%#Eval("CustomerSysNo")%>">
                                                    ...
                                                    <%#Eval("Award").ToString()=="0"?"" : @"<span class=""xs""><img src=""../WebResources/img/paipan/xz2.gif"" /><br />+"+Eval("Award")+"灵签</span>"%>
                                                ...
                                                <div class="index_new_ask_r">
                                                    <h1><a target="_blank" href="../Qin/View.aspx?id=<%#Eval("CustomerSysNo")%>"><%#Eval("NickName")%></a></h1>

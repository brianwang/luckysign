...
{
    public class SendSMS : XMS.Core.TriggerTaskBase
    {
        /// <summary>
        /// 日志目录
        /// </summary>
        const string LogInfoCategory = "SendSMS";
        ...
        public SendSMS(string key, string name)
            : base(key, name) 
        {
        ...
        public override void Execute(DateTime? lastExecuteTime)
        {
            ...
            {
                this.NextExecuteTime = DateTime.Now.AddSeconds(1);
            }
        }
    }
}
